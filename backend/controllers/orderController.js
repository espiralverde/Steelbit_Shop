...
const updateOrdertToPaid = async (req, res, next) => {  
    try{
...
module.exports = { getUserOrders, getOrder, createOrder, updateOrdertToPaid, updateOrderToDelivered, getOrders, getOrderForAnalysis }