//acá meto me mismo código para edit product y create product. Para no repetir el mismo código 2 vecs
...
export const setValuesForAttrFromDbSelectForm = (e, attrVal, attributesFromDb) => {
    if (e.target.value !== "Elegir Atributo") {
        ...
        if (selectedAttr && selectedAttr.value.length > 0) {
            ...
            valuesForAttrKeys.options.add(new Option("Elegir Valor"))
