...
export const cartReducer = (state = CART_INITIAL_STATE, action) => {
    ...
    switch (action.type) {
        case actionTypes.ADD_TO_CART:
            ...
            //const productAlreadyExistsInState = CART_INITIAL_STATE.cartItems.find((x) => x.productID === productBeingAddedToCart.productID);
        ...
        //REEMPLAZO "STATE" POR SU VALOR, PORQUE SINO, NO FUNCIONA
            ...
            if (productAlreadyExistsInState) {
                ...
                //currentState.cartItems = CART_INITIAL_STATE.cartItems.map((x) => {
